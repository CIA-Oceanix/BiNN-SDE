...
## Calculate F from the model weight
    ...
    residual=get_dynamical_model(pred_model,m,m,1)
...
# Generate trajectory using the learned model with BiNN 
    State_train_class=np.zeros((N,m))
    x0=State_init[0,:]
...
# Calculte F from the model weights
    ...
    residual=get_dynamical_model(pred_model_class,m,m,1)
